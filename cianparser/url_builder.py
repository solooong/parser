...
class URLBuilder:
    ...
    def add_district(self, district_type):
        self.url+=DISCRIT_PATH.format(district_type)
    ...
    def add_additional_settings(self, additional_settings):
        ...
        if "district" in additional_settings:
            district_value = additional_settings["district"]
            self.url += f"&district%5B0%5D={district_value}"
